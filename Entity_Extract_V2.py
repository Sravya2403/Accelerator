                                        ...
                                        for key in t['value']:
                                            ...
                                            if dict_map["Nested"][k][key] == "":
                                                ...
                                                for s in t['value'][key]:
                                                    nested_child_dict = {}
                                                    list_of_nested_child_attributes = dict_map["Nested"][k][key]
                                                    nested_child_dict = {key: None for key in list_of_nested_child_attributes}
                                                    if 'value' in s:
    ...
    try:
        for key in dict_map['Nested']:
            ...
            if os.path.isfile(file_path):
                ...
                df = change_dataframe_headers(df, dict_map)
